...
<div id="dcWrap"> <div id="dcHead">
 <div id="head">
  <div class="logo"><a href="index.blade.php"><img src="{{asset('admin')}}/images/dclogo.gif" alt="logo"></a></div>
  <div class="nav">
   <ul>
...
<!-- dcHead 结束 --> <div id="dcLeft"><div id="menu">
 <ul class="top">
  <li><a href="index.blade.php"><i class="home"></i><em>管理首页</em></a></li>
 </ul>
 <ul>
  ...
  <li><a href="page.html"><i class="page"></i><em>单页面管理</em></a></li>
   ...
   <ul>
  <li><a href="/product_category"><i class="productCat"></i><em>商品分类</em></a></li>
